...
```typescript {7-9, 13-15} showLineNumbers  filename="balances.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/composabilitySnippets.ts inline
// group balances-def
