...
```typescript showLineNumbers {31-36} file=<rootDir>/starter-kit-snippets/packages/chain/test/runtime/modules/guestBook.test.ts inline
  // group start
...
```typescript showLineNumbers {38, 40} file=<rootDir>/starter-kit-snippets/packages/chain/test/runtime/modules/guestBook.test.ts inline
  // group start
  // group withQuery
```
