...
5. Sign and send the transaction, and wait for a couple seconds for a block to be produced.
...
import { PrivateKey, Provable, UInt64 } from "o1js";
...
4. Query the latest check-in for the sender address

```typescript showLineNumbers {37-40} filename="packages/chain/test/interaction.test.ts"
import { InMemorySigner } from "@proto-kit/sdk";
import { client as appChain } from "./../src/client.config";
import { PrivateKey, Provable, UInt64 } from "o1js";
import { GuestBook } from "../src/guest-book";
