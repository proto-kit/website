...
```typescript showLineNumbers file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/balances.ts
...
```typescript showLineNumbers file=<rootDir>/starter-kit-snippets/packages/chain/test/runtime/modules/balances.test.ts
// An example jest test suite showing how to test a basic runtime flow
```
