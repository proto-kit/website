...
```typescript showLineNumbers filename="packages/chain/src/balances.ts" file=<rootDir>/framework-snippets/src/quickstart/app-chain/balances.ts
// Example runtime modules Balances with circulatingSupply and addBalance()
```

```typescript file=<rootDir>/framework-snippets/src/quickstart/app-chain/balances.ts inline
// Start
...
```typescript showLineNumbers filename="packages/chain/test/balances.test.ts" file=<rootDir>/framework-snippets/src/quickstart/app-chain/balances.test.ts
