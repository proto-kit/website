...
```typescript {5-7} showLineNumbers filename="packages/chain/src/runtime.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/snippets/configuration.ts
