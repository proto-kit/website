...
```typescript showLineNumbers filename="packages/chain/src/guest-book/check-in.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/guest-book.ts#L3-L11
...
```typescript showLineNumbers filename="packages/chain/src/guest-book/index.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/guest-book.ts#L13-L16
...
```typescript showLineNumbers {5-17} filename="packages/chain/src/guest-book/index.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/guest-book.ts#L13-L30
