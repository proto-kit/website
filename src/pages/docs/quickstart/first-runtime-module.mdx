...
We'll define the _checkIn_ method, which will allow users to check-in in the guest book.
...
```typescript showLineNumbers {10, 18} filename="packages/chain/src/runtime.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/index.ts
