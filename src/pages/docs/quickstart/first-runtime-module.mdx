...
```typescript showLineNumbers {10-22} file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/guest-book.ts inline
// group imports
// group runtime-module-def
...
```typescript showLineNumbers {10, 18} file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/index.ts
