...
To overcome this, we created a number of classes in `@proto-kit/common` that handle all of that for you while providing the same interface as the vanilla variants.
...
<Callout type="default">
    Make sure to import from `@proto-kit/common` when using `UInt32` and `UInt64`
</Callout>
