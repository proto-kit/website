...
<Cards>
  <Card icon={<ExternalLink/>} title="Runtime" href="/docs/protokit/architecture/runtime"/>
  <Card icon={<ExternalLink/>} title="Protocol" href="/docs/protokit/architecture/protocol"/>
  <Card icon={<ExternalLink/>} title="Sequencer" href="/docs/protokit/architecture/sequencer"/>
</Cards>