...
```typescript {9-10} showLineNumbers filename="balances.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/balancesWithZkProof.ts inline
// group start
// group mint
}
```
