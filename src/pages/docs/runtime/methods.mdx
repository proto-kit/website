...
```typescript {9-12} showLineNumbers filename="balances.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/balancesWithZkProof.ts inline
// group start
// group getBalance
}
```
...
```typescript {9-13} showLineNumbers filename="balances.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/balancesWithZkProof.ts inline
// group start
// group mint
}
```
...
```typescript showLineNumbers filename="balances.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/balancesWithZkProof.ts inline
...
```typescript {9-15} showLineNumbers filename="balances.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/balancesWithZkProof.ts inline
// group start
// group transfer
```
