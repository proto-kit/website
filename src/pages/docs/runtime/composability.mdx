...
```typescript {27-30,35-38} showLineNumbers filename="balances.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/composabilitySnippets.ts inline
// group imports
// group balances-def
  // group balances-mint
}
