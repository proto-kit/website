...
```typescript {28-31,36-39} showLineNumbers filename="balances.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/composabilitySnippets.ts#L1-L39
...
```typescript  showLineNumbers filename="vesting.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/composabilitySnippets.ts#L40-L52
