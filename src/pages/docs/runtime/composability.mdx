...
```typescript {24-27,32-35} showLineNumbers filename="balances.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/composabilitySnippets.ts inline
// group imports
...
```typescript  showLineNumbers filename="vesting.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/composabilitySnippets.ts inline
// group imports
