...
```typescript {1-3,7-9,13} showLineNumbers filename="provable-events.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/provable-events.ts inline
...
```typescript {2-6} showLineNumbers filename="provable-events.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/provable-events.ts inline
