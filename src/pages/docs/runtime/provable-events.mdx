...
```typescript {1-3,8-10,14} showLineNumbers filename="provable-events.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/provable-events.ts inline
