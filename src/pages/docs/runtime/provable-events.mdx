...
```typescript {1-2,8-12,14} showLineNumbers filename="provable-events.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/provable-events.ts inline
...
```typescript {2} showLineNumbers filename="provable-events.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/provable-events.ts inline
