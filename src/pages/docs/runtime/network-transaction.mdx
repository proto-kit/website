...
```typescript showLineNumbers {15, 23} filename="mintery.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/mintery.ts inline
// group mintery-def
  // group mint
...
```typescript showLineNumbers {12} filename="guest-book.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/guest-book.ts inline
// group imports
