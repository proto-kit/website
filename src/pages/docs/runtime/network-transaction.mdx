...
```typescript showLineNumbers {9, 20} filename="mintery.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/mintery.ts inline
// group mintery-def
// group mint
...
```typescript showLineNumbers {14} filename="guest-book.ts" file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/guest-book.ts inline
// group imports
