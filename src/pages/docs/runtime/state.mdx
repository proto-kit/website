...
```typescript {8, 10} showLineNumbers file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/composabilitySnippets.ts inline
// group imports
...
```typescript {12-16, 18-21} showLineNumbers file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/composabilitySnippets.ts inline
// group imports
...
```typescript {12-15} showLineNumbers file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/composabilitySnippets.ts inline
// group imports
...
```typescript showLineNumbers file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/guest-book.ts inline
// group storage
...
```typescript {18} showLineNumbers file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/composabilitySnippets.ts inline
// group imports
