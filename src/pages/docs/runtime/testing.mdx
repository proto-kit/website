...
```typescript showLineNumbers file=<rootDir>/starter-kit-snippets/packages/chain/src/runtime/modules/mintery.ts inline
// group imports
// group mintery-def
  // group mint
}
...
```typescript showLineNumbers file=<rootDir>/starter-kit-snippets/packages/chain/test/runtime/modules/mintery.test.ts inline
// group imports
// group test-setup
});
```
