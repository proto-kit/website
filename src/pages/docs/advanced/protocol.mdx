...
```ts  showLineNumbers copy file=<rootDir>/starter-kit-snippets/packages/chain/src/protocol/hooks/TransactionHook.ts inline
...
```ts {2,9} showLineNumbers copy file=<rootDir>/starter-kit-snippets/packages/chain/src/protocol/hooks/TransactionFeeHook.ts inline
...
```typescript copy file=<rootDir>/starter-kit-snippets/packages/chain/src/protocol/hooks/StateRootHistoryHook.ts
